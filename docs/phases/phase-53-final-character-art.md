...
Thay placeholder bằng asset nhất quán cho 4 class và animation cần thiết.

## Đầu vào và phụ thuộc

- [Phase 06 — Player animation](phase-06-player-animation.md).
...
**Điểm cần xử lý trước phần phụ thuộc:** Cần asset hoặc nhiệm vụ tạo asset được giao rõ; nếu chưa có, hoàn thành đặc tả art và ghi phần thay asset chưa thực hiện.

## Các bước thực hiện

1. Chốt style, silhouette bốn class, frame size/origin/hướng và danh sách animation theo skill đang có.
2. Thay placeholder bằng asset có nguồn rõ; ánh xạ animation state mà không đổi luật combat.
3. Kiểm tra sprite scale, attachment, hit timing và khả năng nhận diện khi nhiều nhân vật đứng gần nhau.

## Đầu ra và phạm vi file

- Đường dẫn/thành phần dự kiến: `client character assets/animation config`; `docs/art/ASSET-GUIDE.md`.
...
Tự tạo mọi art dungeon, đổi phong cách chưa được giao hoặc coi concept sheet là sprite sheet.
...
- [ ] Nhìn silhouette/trang bị phân biệt được bốn class trong kích thước chơi thực.
- [ ] Idle/run/attack/hurt/death và skill cần thiết chuyển đúng, không nhảy origin.
- [ ] Thay art không đổi hurtbox/range/damage ngoài quyết định thiết kế được ghi.
...
Chơi cả bốn class, đổi hướng/đánh/chết, xem trên nền sáng/tối và trận nhiều VFX; rà nguồn cùng cấu hình sprite.
...
> Đọc README.md, AGENTS.md và docs/phases/phase-53-final-character-art.md. Thực hiện chỉ Phase 53 trong phạm vi đã mô tả. Kiểm tra đầu ra các phụ thuộc trước khi bắt đầu; không tự làm phase khác để lấp phần thiếu. Hoàn thành các bước được giao, kiểm chứng checklist, cập nhật báo cáo trong file phase và nêu rõ phần còn thiếu. Giữ các đề xuất chưa chốt ở trạng thái đề xuất.

Nếu chỉ muốn tiếp tục review tài liệu, thêm vào yêu cầu: **“Chỉ rà soát/cập nhật tài liệu Phase 53, chưa triển khai code.”**
