# Phase 14 — Ancient Golem prototype
...
Warrior có thể đánh boss solo, né telegraph, thắng hoặc thua.

## Đầu vào và phụ thuộc

- [Phase 13 — Boss framework](phase-13-boss-framework.md).
...
**Điểm cần xử lý trước phần phụ thuộc:** M2 cần bằng chứng chơi thử; không tự ghi gameplay vui nếu chỉ mới build thành công.

## Các bước thực hiện

1. Lắp bản Golem solo theo Phase 3 với các đòn đã chọn và telegraph rõ.
2. Nối combat room → boss → victory/defeat; cho phép bắt đầu lại vòng chơi.
3. Tuning sơ bộ nhịp di chuyển/né/đánh và ghi nhận trải nghiệm, không thêm cơ chế bắt buộc class chưa có.

## Đầu ra và phạm vi file

- Đường dẫn/thành phần dự kiến: `game-client/src/bosses/`; `cấu hình Golem solo`; `luồng kết quả`.
...
Multiplayer, bốn class, rune/crystal bắt buộc tổ đội, loot và art cuối.
...
- [ ] Warrior hoàn thành được vòng phòng quái → Golem → thắng hoặc thua.
- [ ] Người chơi có thể nhận biết và tránh đòn bằng vị trí/thời gian phản ứng.
- [ ] Kết quả xuất hiện một lần và chơi lại không giữ HP/timer cũ.
...
Chơi trọn một lượt thắng, một lượt thua và một lượt restart; ghi lỗi/cảm nhận còn cần review tại gate M2.
...
> Đọc README.md, AGENTS.md và docs/phases/phase-14-golem-prototype.md. Thực hiện chỉ Phase 14 trong phạm vi đã mô tả. Kiểm tra đầu ra các phụ thuộc trước khi bắt đầu; không tự làm phase khác để lấp phần thiếu. Hoàn thành các bước được giao, kiểm chứng checklist, cập nhật báo cáo trong file phase và nêu rõ phần còn thiếu. Giữ các đề xuất chưa chốt ở trạng thái đề xuất.

Nếu chỉ muốn tiếp tục review tài liệu, thêm vào yêu cầu: **“Chỉ rà soát/cập nhật tài liệu Phase 14, chưa triển khai code.”**
