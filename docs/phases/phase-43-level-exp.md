...
Hoàn thành dungeon nhận EXP và tăng trưởng; gear không xóa vai trò cơ chế boss.

## Đầu vào và phụ thuộc

- [Phase 42 — Equipment](phase-42-equipment.md).
...
**Điểm cần xử lý trước phần phụ thuộc:** Curve/cap là cấu hình cần review; không tự cân bằng bằng cách tăng số vô hạn.

## Các bước thực hiện

1. Chốt EXP curve, level cap ban đầu và stat growth tối thiểu.
2. Cấp EXP từ hoàn thành dungeon bằng định danh reward, hỗ trợ vượt nhiều level một lần.
3. Tính lại effective stats, lưu progression và hiển thị level-up sau kết quả authoritative.

## Đầu ra và phạm vi file

- Đường dẫn/thành phần dự kiến: `game-server/ — progression/reward/stats`; `cấu hình EXP`; `client level feedback`.
...
Talent tree, prestige, seasonal progression hoặc skill upgrade chưa được chọn.
...
- [ ] Ngưỡng trước/đúng/sau level-up tính chính xác và không bỏ mất EXP dư.
- [ ] Cùng completion không cấp EXP hai lần; login lại giữ level/EXP.
- [ ] Tăng level không làm mất vai trò rune/crystal/stagger của boss theo thiết kế.
...
Thử EXP sát ngưỡng, nhảy nhiều level, chạm cap, reward lặp và save/load; chơi thử nhân vật ở mức thấp/cao trong phạm vi đã chọn.
...
> Đọc README.md, AGENTS.md và docs/phases/phase-43-level-exp.md. Thực hiện chỉ Phase 43 trong phạm vi đã mô tả. Kiểm tra đầu ra các phụ thuộc trước khi bắt đầu; không tự làm phase khác để lấp phần thiếu. Hoàn thành các bước được giao, kiểm chứng checklist, cập nhật báo cáo trong file phase và nêu rõ phần còn thiếu. Giữ các đề xuất chưa chốt ở trạng thái đề xuất.

Nếu chỉ muốn tiếp tục review tài liệu, thêm vào yêu cầu: **“Chỉ rà soát/cập nhật tài liệu Phase 43, chưa triển khai code.”**
