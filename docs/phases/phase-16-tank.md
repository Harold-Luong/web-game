...
Block, aggro/threat và taunt khiến boss đổi mục tiêu theo luật.
...
**Điểm cần xử lý trước phần phụ thuộc:** Không mặc định boss nào cũng nhận taunt vô hạn; dùng giới hạn từ class/boss design.

## Các bước thực hiện

1. Tạo Tank từ cấu hình và bộ skill MVP đã chốt, ưu tiên Shield Block/Taunt nếu đúng thiết kế.
2. Bổ sung lựa chọn mục tiêu theo threat và quy tắc ưu tiên/hiệu lực taunt.
3. Áp dụng block theo hướng/thời gian/điều kiện đã thiết kế; cung cấp feedback mục tiêu và block.

## Đầu ra và phạm vi file

- Đường dẫn/thành phần dự kiến: `game-client/src/entities/`; `skills Tank`; `aggro/threat/block`.
...
Mọi skill Tank mở rộng, AI đồng đội đầy đủ hoặc lobby/network.
...
- [ ] Taunt làm boss/enemy đổi mục tiêu theo luật, hết hiệu lực thì chọn lại đúng.
- [ ] Block giảm/chặn damage đúng hướng và thời điểm; không vô tình bất tử.
- [ ] Tank dùng cùng movement, skill, damage và lifecycle với Warrior.
...
Dùng hai character để thử taunt, hết taunt, Tank chết và đòn từ trước/sau khi block; kiểm tra HP theo công thức.
...
> Đọc README.md, AGENTS.md và docs/phases/phase-16-tank.md. Thực hiện chỉ Phase 16 trong phạm vi đã mô tả. Kiểm tra đầu ra các phụ thuộc trước khi bắt đầu; không tự làm phase khác để lấp phần thiếu. Hoàn thành các bước được giao, kiểm chứng checklist, cập nhật báo cáo trong file phase và nêu rõ phần còn thiếu. Giữ các đề xuất chưa chốt ở trạng thái đề xuất.

Nếu chỉ muốn tiếp tục review tài liệu, thêm vào yêu cầu: **“Chỉ rà soát/cập nhật tài liệu Phase 16, chưa triển khai code.”**
