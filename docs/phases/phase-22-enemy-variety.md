...
Quái giáp nặng, tầm xa/bay, bầy đàn hoặc charge tạo lợi thế cho từng class.
...
**Điểm cần xử lý trước phần phụ thuộc:** Chọn số archetype tối thiểu đủ chứng minh vai trò; tên Heavy Knight/Brute là gợi ý, không yêu cầu art riêng.

## Các bước thực hiện

1. Chọn tập quái nhỏ đại diện cho giáp nặng, mục tiêu xa/bay, bầy đàn và charge theo thiết kế.
2. Dùng chung AI/combat nền, thêm khác biệt hành vi cần thiết và tín hiệu nhận diện.
3. Đặt các nhóm thử trong room để kiểm chứng lợi thế tự nhiên của bốn class.

## Đầu ra và phạm vi file

- Đường dẫn/thành phần dự kiến: `game-client/src/enemies/`; `cấu hình archetype và encounter thử`.
...
Hàng chục loại quái, loot riêng từng loài, art cuối hoặc hệ khắc chế nguyên tố mới.
...
- [ ] Các archetype tạo quyết định khác nhau về vị trí, ưu tiên mục tiêu hoặc dùng skill.
- [ ] Không có quái bất tử do class counter chết nếu thiết kế không chủ ý cho fail.
- [ ] Quái dùng chung damage/lifecycle và room clear đếm đúng mọi loại.
...
Cho từng class đối mặt archetype phù hợp và không phù hợp; thử room hỗn hợp và dọn hết quái.
...
> Đọc README.md, AGENTS.md và docs/phases/phase-22-enemy-variety.md. Thực hiện chỉ Phase 22 trong phạm vi đã mô tả. Kiểm tra đầu ra các phụ thuộc trước khi bắt đầu; không tự làm phase khác để lấp phần thiếu. Hoàn thành các bước được giao, kiểm chứng checklist, cập nhật báo cáo trong file phase và nêu rõ phần còn thiếu. Giữ các đề xuất chưa chốt ở trạng thái đề xuất.

Nếu chỉ muốn tiếp tục review tài liệu, thêm vào yêu cầu: **“Chỉ rà soát/cập nhật tài liệu Phase 22, chưa triển khai code.”**
